// Fixture-based verification of the Function v6 route fork (task 16.2 /
...
const FUNCTION_ID = 90034
const VERSION_ID = '01JFUNCREADY00000000000001'

const editUrl = `/functions/edit/${FUNCTION_ID}`
const versionUrl = `/functions/edit/${FUNCTION_ID}/versions/${VERSION_ID}`

// Shared landing/editor chrome exposes these stable testids only in v6 chunks.
const v6EditRoot = '[data-testid="edge-functions-v6-edit"]'
const v6VersionEditRoot = '[data-testid="edge-functions-v6-version-edit"]'
const legacyNameField = '[data-testid="field-text__input"]'
...
const stubFunctionScreen = () => {
  cy.intercept('GET', `**/v4/workspace/functions/${FUNCTION_ID}`, {
    fixture: '/edge-functions/function-detail.json'
  }).as('functionDetail')

  cy.intercept('GET', `**/v4/workspace/functions/${FUNCTION_ID}/versions/${VERSION_ID}`, {
    fixture: '/edge-functions/function-version-detail.json'
  }).as('functionVersionDetail')

  cy.intercept('GET', `**/v4/workspace/functions/${FUNCTION_ID}/versions*`, {
    fixture: '/edge-functions/function-versions.json'
  }).as('functionVersions')
}

describe('Edge Functions - v6 flag gating (Mock Test)', { tags: ['@dev3'] }, () => {
  context('Feature flag ON (use_v6_configurations)', () => {
    ...
    it('loads the v6 edit chunk on the function edit route', () => {
      cy.visit(editUrl)
