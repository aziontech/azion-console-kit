...
describe('Your Settings spec', () => {
  ...
  it('should edit user settings but the email', () => {
    ...
    cy.getByTestId('profile__first-name__input__error-message')
      .should('be.visible')
    ...
    cy.getByTestId('profile__last-name__input__error-message')
      .should('be.visible')
    ...
    cy.getByTestId('contact__email__input__error-message')
      .should('be.visible')
