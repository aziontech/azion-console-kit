export default {
  ...
  serverCertificateTextArea: '[data-testid="import-server-certificate-form__certificate-field__textarea"]',
  ...
  clickImportServerCertificate: '#overlay_menu_0_0 > .p-menuitem-content > .p-menuitem-link',
  clickGenerateCSR: '#overlay_menu_0_1 > .p-menuitem-content > .p-menuitem-link',
  clickImportTrustedCertificate: '#overlay_menu_1_0 > .p-menuitem-content > .p-menuitem-link',
  clickImportCRL: '#overlay_menu_1_1 > .p-menuitem-content > .p-menuitem-link',
