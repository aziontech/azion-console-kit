export default {
  ...
  filterDomains: '[data-testid="data-stream-form__domains__options-field__radio__domainOption-radio-1"]',
  optionsSources: '[data-testid="picklist__field"] .p-picklist-source-wrapper .p-picklist-source-list .p-picklist-item',
  optionsTarget: '[data-testid="picklist__field"] .p-picklist-target-wrapper .p-picklist-target .p-picklist-item',
  moveToTarget: '[data-testid="picklist__move-to-target-btn"]',
  searchSource: '[data-testid="search-input-source"]',
  searchTarget: '[data-testid="search-input-target"]',
  templateDropdown: '[data-testid="data-stream-form__data-settings__template-field__dropdown"]',
  templateOption: (index) => `#template_${index}`,
