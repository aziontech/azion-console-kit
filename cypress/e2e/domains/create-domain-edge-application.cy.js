...
describe('Domains spec', { tags: ['@dev3'] }, () => {
  ...
  it('should create and delete a domain using a edge application', () => {
    ...
    cy.intercept('GET', '/api/v4/digital_certificates/certificates?ordering=name&page=1&page_size=100&fields=id%2Cname&search=azion').as('searchDigitalCertificatesApi')
