...
describe('Edge Application', { tags: ['@dev4'] }, () => {
  ...
  it('should create a rule engine set cache policy', () => {
    ...
    cy.intercept('POST', '/v4/workspace/applications/*/cache_settings').as('createCacheSetting')
    cy.intercept('GET', '/v4/workspace/applications/*/cache_settings?page_size=100').as('getCacheSetting')
