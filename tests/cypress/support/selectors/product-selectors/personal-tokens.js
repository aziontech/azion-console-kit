export default {
  ...
  calendar: '[data-testid="personal-token-form__expiration__calendar"]',
  dropdownExpiration: '[data-testid="personal-token-form__expiration-dropdown"]',
  dropdownOption: '#selectedExpiration_6', 
