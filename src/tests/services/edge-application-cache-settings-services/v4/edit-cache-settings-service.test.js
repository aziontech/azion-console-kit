...
import { editCacheSettingsService } from '@/services/edge-application-cache-settings-services/v4'
...
describe('EdgeApplicationCacheSettingsServices', () => {
  it('should be able to call Api with correct params', async () => {
    ...
    expect(requestSpy).toHaveBeenCalledWith({
      url: `v4/edge_application/applications/${fixtures.cacheSettingsMock.edgeApplicationId}/cache_settings/${fixtures.cacheSettingsMock.id}`,
      method: 'PUT',
      body: {
  ...
  it('should return a feedback when successfully create an cache settings', async () => {
    ...
    expect(result).toEqual('Cache Settings successfully edited')
  })
