...
import { loadHttpRequest } from '@/services/real-time-events-service-v2/http-request'
  ...
  it('should parse and merge events correctly', async () => {
    ...
    expect(response).toEqual({
      data: [
        ...
        { key: 'wafLearning', value: fixtures.httpRequestFirst.wafLearning },
        { key: 'wafMatch', value: fixtures.httpRequestFirst.wafMatch },
        ...
        { key: 'wafBlock', value: fixtures.httpRequestFirst.wafBlock },
        { key: 'wafScore', value: fixtures.httpRequestFirst.wafScore },
        { key: 'wafTotalBlocked', value: fixtures.httpRequestFirst.wafTotalBlocked },
