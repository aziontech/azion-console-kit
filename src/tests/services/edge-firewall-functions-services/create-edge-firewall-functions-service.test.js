...
import { createFunctionService } from '@/services/edge-firewall-functions-services/create-function-service'
...
describe('CreateFunctionService', () => {
  it('should call API with correct params and parse args as JSON', async () => {
    ...
    expect(requestSpy).toHaveBeenCalledWith({
      url: `v3/edge_firewall/${fixtures.functionMock.id}/functions_instances`,
      method: 'POST',
      body: {
