...
import { editIntelligentDNSService } from './edit-intelligent-dns-service';
import { loadIntelligentDNSService } from './load-intelligent-dns-service';

export {
  listIntelligentDNSService,
  deleteIntelligentDNSService,
  createIntelligentDNSService,
  editIntelligentDNSService,
  loadIntelligentDNSService
}
