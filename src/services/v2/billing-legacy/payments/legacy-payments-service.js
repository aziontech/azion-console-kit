...
import { LegacyPaymentsAdapter } from './legacy-payments-adapter'
export class LegacyPaymentsService extends BaseService {
  constructor() {
    super()
    this.adapter = LegacyPaymentsAdapter
    this.baseURL = {
...
export const legacyPaymentsService = new LegacyPaymentsService()
