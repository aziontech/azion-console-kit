const messageErrors = {
    ddress_conflicts_with_cname: 'Can\'t configure Origin Address "{0}", because it is in use by a CNAME.',
    address_localhost_block: 'Can\'t configure Origin Address "{0}", because its use is not allowed.',
    broken_json: "Unfortunately an error occurred and we couldn't process the data sent through the form. Please, try again later.",
    bucket_not_found: '"{0}" is not a valid bucket.',
    cant_specify_port_with_preserve_protocol: "Can't specify Origin Address port when preserving protocol.",
    cname_already_in_use: 'CNAMEs already in use: {0}',
    cname_in_origin_address: 'You can\'t use "{0}" as CNAME because it is already in an Origin Address.',
    cname_invalid_format: 'Invalid CNAME format: "{0}".',
    cname_invalid_tld: 'It\'s not possible to use a CNAME which is an invalid top level domain: "{0}".',
    cname_overwrite_other_cnames: 'The following CNAME(s) cannot be used, in order to avoid CNAMEs overwriting: {0}',
    cname_used_as_domain: 'You can\'t use "{0}" as CNAME because it is already used as Domain.',
    could_not_generate_domain_name: 'It was not possible to generate a new Domain Name. Please, try again later or contact the support service.',
    custom_error_responses_requires_uri: "You can't set up a Custom Status Code without setting up an URI.",
    duplicated_domain_name: 'A Domain with the name "{0}" already exists.',
    related_domains_exceeded: 'Domain limit exceeded. You cannot associate new domains with edge application {0}.',
    ...
    invalid_account_edge_application: 'In order to perform this action, you must first have access to "{0}"',
    ...
    invalid_cname_access_only: 'At least one valid CNAME is needed in order to enable "CNAME Access Only".',
    ...
    edge_functions_disabled: 'Enable Edge Functions on the Edge application before creating a new Edge Function',
    missing_address: 'The field "Address" is required',
    missing_browser_cache_settings_maximum_ttl: 'When overriding the Browser Cache Settings, you must provide a value for "Maximum TTL".',
    missing_bucket: 'The field "Bucket" is required',
    missing_cdn_cache_settings_maximum_ttl: 'When overriding the CDN Cache Settings: you must provide a value for "Maximum TTL".',
    ...
    user_has_no_product: 'In order to perform this action, you must first have access to the product "{0}"',
    edge_application_already_in_use: "It's not possible to use an Edge Application which is already in use.",
    ...
    domain_not_deployed: "Remember to deploy your changes when you're done. Your changes won't take effect until you deploy it.",
    ...
    originless_cache_settings: "It's not possible to create Cache Settings for Originless Edge Application",
    ...
    cannot_create_same_edge_application: 'It is not possible to create multiple Edge Applications at the same time',
    detail: '{0}',
  };
