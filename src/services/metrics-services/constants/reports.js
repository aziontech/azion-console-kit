...
const REPORTS = [
   ...
   */
  {
    ...
    chartOwner: 'azion',
    label: 'Tiered Cache',
    description: DASHBOARDS_TEXTS.tiered_caching.caching_offload.tiered_caching.description,
    aggregationType: 'sum',
    columns: 6,
    type: 'line',
    xAxis: 'ts',
  ...
  },
  {
    ...
    description: DASHBOARDS_TEXTS.tiered_caching.caching_offload.tiered_offload.description,
    aggregationType: 'avg',
    columns: 6,
    type: 'line',
    xAxis: 'ts',
