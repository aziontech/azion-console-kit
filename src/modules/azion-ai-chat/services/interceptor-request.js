 ...
 * @param {Object} requestDetails.prompt - The prompt that determines the origin of the chat call.
 * @returns {Object} The modified request details with added properties.
 */
