...
const INT_FIELD_OPERATORS = [
  ...
  { label: 'Less Than', value: { value: 'Lt', label: 'Less Than', format: '<', type: 'Int' } },
  {
    ...
    value: { value: 'Lte', label: 'Less Than or Equal', format: '<=', type: 'Int' }
  },
  {
    label: 'Greater Than',
    value: { value: 'Gt', label: 'Greater Than', format: '>', type: 'Int' }
  },
  {
  ...
  {
    label: 'Between',
    value: { value: 'Range', label: 'Between', format: 'between', type: 'IntRange' }
  },
...
const DETERMINISTIC_PARSE_CASES = [
  {
    query: 'status = 200',
    expected: [{ field: 'status', value: 200, operator: 'Eq', valueField: 'status', type: 'Int' }]
  },
  {
    query: 'status <> 500',
    expected: [{ field: 'status', value: 500, operator: 'Ne', valueField: 'status', type: 'Int' }]
  },
  {
    query: 'status > 100',
    expected: [{ field: 'status', value: 100, operator: 'Gt', valueField: 'status', type: 'Int' }]
  },
  {
    query: 'status >= 200',
    expected: [{ field: 'status', value: 200, operator: 'Gte', valueField: 'status', type: 'Int' }]
  },
  {
    query: 'status < 500',
    expected: [{ field: 'status', value: 500, operator: 'Lt', valueField: 'status', type: 'Int' }]
  },
  {
    query: 'status <= 499',
    expected: [{ field: 'status', value: 499, operator: 'Lte', valueField: 'status', type: 'Int' }]
  },
  {
