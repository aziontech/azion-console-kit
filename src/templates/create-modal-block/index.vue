...
<div  class="lg:w-[880px] sm:w-[85vw] min-h-[500px] flex p-8 gap-6">
  ...
  />
  <div class="pb-4 h-full w-full gap-4 animate-pulse" v-if="isLoading" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(288px, 1fr));">
    <PrimeCard
      :pt="{
        root: 'w-72 p-4',
        body: 'w-full'
  ...
  <div class="h-full w-full gap-4" v-if="!isLoading && selectedTab === 0" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(288px, 1fr));">
    <PrimeCard
      ...
      <template #content>
        <div class="flex gap-3.5 flex-col">
          <div class="w-10 h-10 rounded flex justify-center items-center">
            <img class="rounded" :src="template.vendor.icon" alt=""/>
          </div>
  ...
  <div class="h-full w-full gap-4" v-if="!isLoading && selectedTab === 1" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(288px, 1fr));">
    <PrimeCard
  ...
  <div class="h-full w-full gap-4" v-if="!isLoading && selectedTab === 2" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(288px, 1fr));">
    <PrimeCard
