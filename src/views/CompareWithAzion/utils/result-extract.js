const formatViewDataTest = (data) => {
    return {
        ...
        securityHeaders: {
            securityHeadersList: data && data.securityHeaders ? data.securityHeaders.securityHeadersList : [],
            securityHeadersGrade: data && data.securityHeaders ? data.securityHeaders.securityHeadersGrade : "",
            securityHeadersScore: data && data.securityHeaders ? data.securityHeaders.securityHeadersScore : ""
        },
        chromeUserTiming: {
