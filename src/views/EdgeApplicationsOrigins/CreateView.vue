            ...
            <template #inputs>
              ...
              <div class="flex flex-col sm:max-w-lg w-full gap-2">
                ...
                <div class="text-color-secondary text-sm font-normal">
                  Azion can request your content from a directory in your origin. Azion appends
                  Origin Path to the URI when forwarding the request to your origin. Leave it in
                  blank to use only the URI.
                </div>
                <small
              ...
              >
                <div class="flex flex-col sm:max-w-lg w-full gap-2">
                  ...
                  <div class="text-color-secondary text-sm font-normal">
                    ...
                    server from which you want Azion to get your content. If your origin does not
                    use standard ports (80/HTTP and 443/HTTPS) you can use the domain:port notation
                    in this field.
                  </div>
                </div>
