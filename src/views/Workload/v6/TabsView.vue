<script setup>
  ...
  import EditViewSkeleton from '@/views/Workload/v6/components/EditViewSkeleton.vue'
  import EditView from '@/views/Workload/v6/EditView.vue'
  import OverviewTab from '@/views/Workload/v6/Tabs/OverviewTab.vue'
  import WorkloadReleasesSection from '@/views/Workload/v6/Tabs/sections/WorkloadReleasesSection.vue'
  import CreateDeploymentVersionDrawer from '@/views/Workload/v6/FormFields/components/CreateDeploymentVersionDrawer.vue'
