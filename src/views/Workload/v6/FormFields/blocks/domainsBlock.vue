<script setup>
  ...
  import DomainRow from '@/views/Workload/v6/FormFields/components/DomainRow.vue'
  import DomainDrawer from '@/views/Workload/v6/FormFields/components/DomainDrawer.vue'
