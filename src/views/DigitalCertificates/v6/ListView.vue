<script setup>
  ...
  import { useDigitalCertificateV6 } from './composables/certificate'
  import CreateMenuBlock from '@/views/DigitalCertificates/CreateMenuBlock.vue'
  import ListTable from '@/components/list-table'

  /**@type {import('@/plugins/analytics/AnalyticsTrackerAdapter').AnalyticsTrackerAdapter} */
  const tracker = inject('tracker')

  defineOptions({ name: 'digital-certificates-view-v6' })
