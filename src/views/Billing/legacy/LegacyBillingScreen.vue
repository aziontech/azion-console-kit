...
<script setup>
  ...
  import PaymentListView from '@/views/Billing/PaymentListView.vue'
  ...
  import { loadContractData, loadBillingData } from '@/helpers/account-data'
  ...
  const getTabFromValue = (selectedTabIndex) => {
    ...
    return tabNames.find((tabName) => TABS_MAP[tabName] === selectedTabIndex)
  }
