    ...
    <template #inputs>
      <div class="flex flex-col w-full gap-2 sm:max-w-lg">
        <FieldText
          ...
          :label="'Account Name'"
          :required="true"
          data-testid="group-form__company-name"
        />
      </div>
      <div class="flex flex-col w-full gap-2 sm:max-w-lg">
        <FieldText
    ...
    <template #inputs>
      <div class="flex flex-col w-full gap-2 sm:max-w-lg">
        <FieldDropdown
          ...
          data-testid="group-form__country"
        />
      </div>
      <div class="flex flex-col w-full gap-2 sm:max-w-lg">
        <FieldDropdown
          ...
          data-testid="group-form__region"
        />
      </div>
      <div class="flex flex-col w-full gap-2 sm:max-w-lg">
        <FieldDropdown
      ...
      <div class="flex flex-col w-full gap-2 sm:max-w-lg">
        <FieldText
          ...
          data-testid="group-form__address"
        />
      </div>
      <div class="flex flex-col w-full gap-2 sm:max-w-lg">
        <FieldText
          ...
          data-testid="group-form__complement"
        />
      </div>
      <div class="flex flex-col w-full gap-2 sm:max-w-lg">
        <FieldText
          data-testid="group-form__postal-code"
          label="Postal Code"
          required
          name="postalCode"
