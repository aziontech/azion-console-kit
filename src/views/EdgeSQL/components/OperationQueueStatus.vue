  ...
  >
    ...
    <i 
      :class="[
        statusIcon,
        'text-sm',
        queueSummary.status === 'processing' ? 'text-primary-600' :
        queueSummary.status === 'pending' ? 'text-yellow-600' :
        'text-green-600'
      ]"
    ></i>
    ...
    <div v-if="stats.creating > 0 || stats.deleting > 0" class="flex items-center gap-1">
      <Badge 
