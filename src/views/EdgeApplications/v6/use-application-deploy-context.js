...
// DeployDrawerBlock for an Edge Application: resourceId/name + the ready
// versions (deployable) pre-filled from the current version.
export function useApplicationDeployContext() {
