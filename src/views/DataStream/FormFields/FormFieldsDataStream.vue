    ...
    <template #inputs>
      ...
      >
        ...
        <div class="flex flex-col sm:max-w-lg w-full gap-2">
          ...
          >
          The prefix for the name of your uploaded object. The name consists of the Prefix, the date and time the packets are sent in the YYYY/MM/DD/hh/mm/ format, and the UUID. <br/> Example: user/logs/2024/10/12/06/24/37d66e78-c308-4006-9d4d-1c013ed89276.          </small>
          <small
            id="object-key-help"
            class="p-error"
