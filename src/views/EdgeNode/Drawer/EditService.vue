<script setup>
  ...
  const editService = async (payload) => {
    return await ServiceEdgeNode.editServiceEdgeNodeService({
      ...payload,
      serviceId: props.serviceIdEdgeNode
    })
  }

  const loadService = async (payload) => {
    const edgeNode = await ServiceEdgeNode.loadServiceEdgeNodeService({
      ...payload,
      serviceId: props.serviceIdEdgeNode
    })
