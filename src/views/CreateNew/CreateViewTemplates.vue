      ...
      <div class="w-full min-h-full flex flex-col xl:flex-row px-1 gap-4 xl:gap-8 mt-4 md:mt-8">
        ...
        >
          ...
          >
            ...
            <button
              class="w-64 h-8 px-2.5 py-1.5 rounded surface-border border inline-flex justify-start items-center gap-3 hover:surface-100 transition-colors"
              @click="goBackToMenu"
            >
