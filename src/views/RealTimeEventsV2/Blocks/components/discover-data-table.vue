          ...
          <span class="dynamic-field-cell group/dyn">
            ...
            <span class="dynamic-field-actions">
              <PrimeButton
                ...
                class="!w-5 !h-5 !p-0"
                @click.stop="
                  emit('add-filter', fieldName, getFieldValue(rowData, 'field_' + fieldName))
                "
              />
              <PrimeButton
                ...
                class="!w-5 !h-5 !p-0"
                @click.stop="
                  emit('exclude-filter', fieldName, getFieldValue(rowData, 'field_' + fieldName))
                "
              />
            </span>
          </span>
