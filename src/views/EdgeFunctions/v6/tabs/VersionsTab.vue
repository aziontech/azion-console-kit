<script setup>
  // VersionsTab — the version LISTING body of the v6 Edge Functions screen.
  ...
  const versionsQuery = edgeFunctionVersionService.useListVersionsQuery(edgeFunctionId.value)
