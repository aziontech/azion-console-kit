<template>
  <GraphsCard chartOwner="azion" title="Four Columns Card"
    ...
    :cols="4" aggregationType="Average" variationType="positive" variationValue="10.2%">
    <template #chart>
...
<script setup>
import GraphsCard from '@/templates/graphs-card-block';
